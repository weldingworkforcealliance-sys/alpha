  ...
  return (
    <div className="shell">
      <div className="demo-banner">
        PUBLIC DEMO · TEMPORARY SESSION · NO LIVE SCHOOL DATA
      </div>

      <header>
        <div>
          <div className="eyebrow">Living Teacher Guide</div>
          <h1>Welding Demo Workspace</h1>
        </div>
          ...
          <div className="grid">
            ...
            <section className="panel">
              ...
              <div className="limited">
                This workspace is temporary. Activity stays inside the demo session and is discarded automatically.
              </div>
            </section>
          </div>
        )}
