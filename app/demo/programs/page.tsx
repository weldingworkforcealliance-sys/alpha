  ...
  return (
    <div className="shell">
      ...
      <style jsx>{`
        ...
        @media(max-width:760px) { header { align-items:flex-start; padding:24px 16px; } h1 { font-size:25px; } .programs,.message { grid-template-columns:1fr; } .card { min-height:320px; padding:22px; } }
      `}</style>
    </div>
  );
}
