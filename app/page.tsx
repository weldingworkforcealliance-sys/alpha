...
const features = [
  ...
  {
    title: 'Attendance',
    body: 'Records daily attendance, completion status, instructor notes, history, and school reporting in one operating workflow.',
  },
  {
    ...
    <main className="ltg-marketing">
      ...
      <section className="ltg-marketing-section ltg-marketing-security">
        ...
        <p className="ltg-marketing-security-note">
          School-to-school data isolation and privileged database access are being treated as release
          gates before additional institutions are added to the production environment.
        </p>
      </section>
      ...
      <section className="ltg-marketing-beta" id="beta">
        <div>
          ...
          <h2>We are preparing LTG for a small group of partner programs.</h2>
          <p>
            Initial partners will receive guided setup, program configuration, administrator and
            instructor onboarding, support, and a defined feedback process. Access will remain
            controlled while the multi-school release is validated.
          </p>
        </div>
